...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
    ...
    <nav id="scrollspy" class="navbar page-navbar navbar-dark navbar-expand-md fixed-top" data-spy="affix" data-offset-top="20">
        <div class="container">
            <a class="navbar-brand" href="#"><strong class="text-primary">NAS</strong><span class="text-light">VAD</span></a>
            ...
            <div class="row h-100 align-items-center">
                <div class="col-md-7">
                    <div class="header-content">
                        <h3 class="header-title"><strong class="text-primary">NAS</strong><span>VAD</span></h3>
                        <h4 class="header-subtitle">Welcome to my website!</h4>
                        <p>Need an app for your issue? Get contact with Nasvad and I take care on it!</p>
                        <button class="btn btn-outline-light btn-flat">Veja os serviços disponíveis →</button>
                    </div>  
                </div>
                <div class="col-md-5 d-none d-md-block">
                    <form class="header-form">
                        <div class="head">Let's get started! Put your <span class="text-primary">infos</span> below! </div>
                        <div class="body">
    ...
    <div class="social-wrapper" id="features">
        <div class="container">
            <div class="social-txt">
                ...
                <p class="subtitle">you can see how I work on the social networks on the side</p>
            </div>
        ...
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-md-5 align-self-center mb-4 mb-md-0">
                    <img src="assets/imgs/img.jpg" alt="" class="shadow w-100">
                </div>
        ...
        <div class="container">
            <div class="row justify-content-between">               
                ...
                <div class="col-md-5 mt-4 mt-md-0">
                    <img src="assets/imgs/img1.jpg" alt="" class="shadow w-100">
                </div>
            </div>
        </div>
    </section>
    <section class="section" id="about">
        <div class="container text-center">
            <h6 class="display-4 has-line">WHY CHOOSE NASVAD?</h6>
            <p class="mb-5 pb-4">Get your own applications and websites with a professional work and tool up your business</p>

            <div class="row">
                <div class="col-lg-4">
                    <div class="circle-100 mb-3"><i class="ti-light-bulb"></i></div>
                    <h6 class="title mb-3">Thoughtful Design</h6>
                    <p>The Material Design is the standard type of design that I use on my systems! Making your app/websites very beautiful!</p>
                </div>
                <div class="col-lg-4">
                    <div class="circle-100 mb-3"><i class="ti-paint-bucket"></i></div>
                    <h6 class="title mb-3">WELL CRAFTED</h6>
                    <p>I've a professional workspace to craft your project and make it in the safest and most well-built way possible!</p>
                </div>
                <div class="col-lg-4">
                    <div class="circle-100 mb-3"><i class="ti-marker-alt"></i></div>
                    <h6 class="title mb-3">EASY TO CUSTOMIZE</h6>
                    <p>And the best feature is the easily customization I can offer to you! You can make your own customizes with me and put on your project!</p>
                </div>
            </div>
        </div>
    </section>
    <section class="section" id="pricing">
        <div class="container text-center">
            ...
            <p class="mb-5 pb-4">The best service I can offer to you, with the best price too.</p>
            <div class="row pt-5">
                <div class="col-lg-4">
                    <a href="javascript:void(0)" class="pricing-card">
                        ...
                        <ul class="list-group">
                            <li class="list-group-item">2,5 GB TO MEDIA CONTENT</li>
                ...
                <div class="col-lg-4">
                    <a href="javascript:void(0)" class="pricing-card popular">
                        ...
                        <div class="body">
                            <h1><small>$</small>109,99</h1>
                            <p>Quarterly Payment</p>
                        </div>
                        <div class="popular-item">HOT CHOOSED</div>
                        <ul class="list-group">
                            <li class="list-group-item">5 GB TO MEDIA CONTENT</li>
                            <li class="list-group-item">25 GB OF BANDWIDTH</li>
                            <li class="list-group-item">7 WEBSITES</li>
                ...
                <div class="col-lg-4">
                    <a href="javascript:void(0)" class="pricing-card">
                        <div class="head">Enterprises</div>
                        <div class="body">
                            <h1><small>$</small>239,99</h1>
                            <p>Quarterly Payment</p>
                        </div>
                        <ul class="list-group">
                            <li class="list-group-item">UNLIMITED OF SPACE TO MEDIA CONTENT</li>
    ...
    <section class="section" id="review">
        <div class="container text-center">
            ...
            <p class="mb-5 pb-4">People like you, saying what your business turn on it</p>
                    ...
                    <div class="testmonial">                        
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <p class="text-muted">Supermarket Owner</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="testmonial">                        
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <p class="text-muted">Steakhouse Owner</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="section has-img-bg text-center">
        <div class="container">
            <h6 class="display-3 has-line">STYLISH MATERIAL DESIGN</h6>
            <h5 class="mb-5 font-weight-light">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Inventore, itaque.</h5>
            <button class="btn btn-outline-light btn-flat">Checkout</button>
        </div>
    </section>
    <section class="section" id="contact">
        <div class="container text-center">
            <h6 class="display-4 has-line">CONTACT ME</h6>
            <p class="mb-5 pb-2">What you waiting for? Get in contact with me!</p>
